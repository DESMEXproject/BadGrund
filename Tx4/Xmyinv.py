...
M.add_inv_domains(-1500., invpoly, cell_size=1.2e6)
...
# run inversion
invmodel = inv.run(fop.measured, fop.errors, lam=.1, verbose=True,
                    # robustData=True,
                    # blockyModel=True,
