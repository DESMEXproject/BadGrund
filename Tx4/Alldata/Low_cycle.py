...
data1 = CSEMData(datafile="Tx4_1/*.mat", txPos=txpos)
data2 = CSEMData(datafile="Tx4_2/*.mat", txPos=txpos)
# data4 = CSEMData(datafile="Tx4_4/tf/*.mat", txPos=txpos)
# data8 = CSEMData(datafile="Tx4_8/tf/*.mat", txPos=txpos)
# data32 = CSEMData(datafile="Tx4_32/tf/*.mat", txPos=txpos)
# %% Combining the datas
...
# txpos = np.genfromtxt("Tx4.pos").T[:, ::-1]
# data2 = CSEMData(datafile="Tx4_32/tf/*.mat", txPos=txpos)
# data2.setOrigin([580000., 5740000.])
