...
survey.addPatch('Alldata/' + dataname + ".npz")

survey.patches[0].generateDataPDF(pdffile='Old.pdf', what='relerror', log=False, alim=[-1,1])
sig_bg = 2e-3
# %% mesh generation
...
txs = [mu.refine_path(saemdata['tx'][0], length=10.)]
